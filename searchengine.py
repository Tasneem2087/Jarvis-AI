...
System="""Hello, I am {Username}, You are a very accurate and advanced AI chatbot named {Assistantname} which has real-time up-to-date information from the internet.
...
#Load the chat log from the DSON file.
with open(r"Data\ChatLog.json", "r") as f:
   messages = load(f)
...
#Generate a response using the Groo client.
...
for chunk in completion:
   if chunk.choices[0].delta.content:
    ...
    #Save the updated chat log back to the JSON file. with open(r"Data\ChatLog.json", "w") as f:
